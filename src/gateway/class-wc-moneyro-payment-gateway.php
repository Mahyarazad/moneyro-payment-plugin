...
class WC_Moneyro_Payment_Gateway extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_api_' . strtolower($this->id), [$this->payment_gateway_service, 'return_from_gateway']);
        
        add_action('woocommerce_checkout_order_processed', [$this, 'handle_checkout_payment'], 10, 1);
    ...
    public function handle_checkout_payment($order_id) {
        // Get the order
    ...
    public function process_payment($order_id) {
        // This method may still be necessary for other calls
    }
}
?>
